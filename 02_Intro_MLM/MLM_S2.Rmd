...
>>>>>>> 02e24526fdd6cf191c8ec3477d7e42e65e228fe6
...
<<<<<<< HEAD
![The 15 Women Left on the Show](images/Remaining Women.png)
=======
...
$$
<<<<<<< HEAD
like_{ij} = \beta_{0j} + \beta_{1j}*interaction_{ij} + r_{ij}
=======
...
$$
<<<<<<< HEAD
like_{ij} = (\gamma_{00} + \mu_{0j})+ (\gamma_{10} + \mu_{1j})*interaction_{ij} + r_{ij}
=======
...
<<<<<<< HEAD
### An Alogrithm's Journey: Optimizing Parameter Estimates
=======
...
=======
## Decomposing within versus between variance. 
>>>>>>> 02e24526fdd6cf191c8ec3477d7e42e65e228fe6
...
![The 4 Women Left on the Show](images/Remaining Women after Wk 7.png)
